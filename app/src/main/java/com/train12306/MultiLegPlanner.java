...
public class MultiLegPlanner {
    ...
    public static String[] getBuiltinPrompts() {
        return new String[]{
            "排除换乘时间<30分钟的路线，排除总耗时比直达多50%以上的路线，按总时长排序推荐最优的2-3条",
            "排除绕路明显的路线，排除夜间(23:00-06:00)换乘的方案，优先推荐高铁/动车组合",
            "全面分析每条路线的优缺点（换乘次数、总耗时、等待时间），按性价比排序推荐",
            "排除换乘等待>4小时的方案，优先推荐换乘次数少、总时长短的路线"
        };
    }
